      ...
      html: `
        <div style="font-family:Georgia,serif;max-width:520px;margin:0 auto;background:#F0ECE6;padding:40px 32px;border-radius:12px;">
          ...
          <div style="background:#2D3D35;border-radius:10px;padding:20px 24px;margin:0 0 20px;">
            ...
            <a href="https://www.assistedstretches.com/#/new-patient-form" style="display:inline-block;background:#C8856A;color:#fff;text-decoration:none;padding:12px 24px;border-radius:6px;font-size:14px;font-weight:600;">New Patient Form →</a>
          </div>
