...
function PaymentForm({ booking, onSuccess, isGiftFlow }) {
  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <p style={{ fontSize: 14, color: C.textSec, marginBottom: 24, lineHeight: 1.6 }}>
        A <strong style={{ color: C.forest }}>$50 deposit</strong> is charged now to secure your booking. The remaining balance is payable on the day.
      </p>
